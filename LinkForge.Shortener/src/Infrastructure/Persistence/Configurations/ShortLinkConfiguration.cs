...
public class ShortLinkConfiguration : IEntityTypeConfiguration<ShortLink>
{
    public void Configure(EntityTypeBuilder<ShortLink> builder)
    {
        ...
        /*builder.OwnsOne(x => x.OriginalUrl, originalUrl =>
        {
            originalUrl.Property(u => u.Value).HasColumnName("short_code").IsRequired().HasMaxLength(2048);
        });*/
        ...
        /*builder.OwnsOne(x => x.OriginalUrl, originalUrl =>
        {
            originalUrl.Property(u => u.Value).HasColumnName("original_url").IsRequired().HasMaxLength(2048);
        });*/
